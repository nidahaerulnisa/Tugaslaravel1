              ...
              <form action="/anggota/store" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="tanggal_pengembalian" placeholder="Input Pengembalian">
                    <label for="exampleInputEmail1">Tanggal Denda</label>
                    <input type="number" class="form-control" name="tanggal_denda" placeholder="Input Denda">
